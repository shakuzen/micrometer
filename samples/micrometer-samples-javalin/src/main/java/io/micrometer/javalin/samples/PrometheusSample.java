...
import io.micrometer.instrumentation.jetty.JettyConnectionMetrics;
import io.micrometer.instrumentation.jetty.JettyServerThreadPoolMetrics;
import io.micrometer.instrumentation.jetty.TimedHandler;
...
import io.micrometer.instrumentation.system.ProcessorMetrics;
